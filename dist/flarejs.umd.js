!(function (e, t) {
    ...
    var e = {
        ...
        n = function (e, t, n, a) {
            ...
            if (!r[n].hasOwnProperty(t)) throw new Error('Cannot convert from ' + t + ' to ' + n);
            var o = r[n][t] * e;
            ...
            return (
                (function (e, r) {
                    ...
                    var u = /^#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})?$/,
                        ...
                        f = /^rgba?\(\s*(\d+%)\s*,\s*(\d+%)\s*,\s*(\d+%)(?:\s*,\s*(0|1|0?\.\d+|\d+%))?\s*\)$/,
                        p = /^rgba?\(\s*(\d+%)\s+(\d+%)\s+(\d+%)(?:\s*\/\s*(0|1|0?\.\d+|\d+%))?\s*\)$/,
                        h = /^hsla?\(\s*(\d+)(deg|rad|grad|turn)?\s*,\s*(\d+)%\s*,\s*(\d+)%(?:\s*,\s*(0|1|0?\.\d+|\d+%))?\s*\)$/;
                    function m(e, t) {
                    ...
                    function x(e) {
                        return a.default[e]
                            ...
                            : u.test(e) || d.test(e)
                              ...
                              : c.test(e) || f.test(e) || g.test(e) || p.test(e)
                                ? (function (e) {
                                      var t = s(c.exec(e) || f.exec(e) || g.exec(e) || p.exec(e), 5),
                                          r = t[1],
                                          n = t[2],
                                          a = t[3],
                                          o = t[4];
                    ...
                    r.default = { fromString: x, fromRgb: b, fromRgba: y, fromHsl: w, fromHsla: k };
                })(0, r.exports),
                r.exports
            );
        })(),
        o = new /*#__PURE__*/ ((function () {
            ...
            return (
                (t.prototype.load = function (t, r, n) {
                    ...
                    o.length &&
                        ((t.options = Object.assign({}, e, r)),
                        (t.glowElements = []),
                        o.forEach(function (e) {
                            var r = window.getComputedStyle(e, null).getPropertyValue('background-color'),
                                n = t.options.bgColor;
                            null !== n && (n = a.fromString(n).toRgbString()),
                                t.glowElements.push({ element: e, defaultBackground: null === n ? r : n });
                        }),
                        (t.glowRadius = t.options.glowRadius),
                        (t.flareColor = a.fromString(t.options.flareColor).toRgbString()),
                        (t.eventHandlers = []),
                        (t.isPaused = !1),
                        (t.initialized = !0));
                }),
    ...
    return (function () {
        function e(e, t) {
            o.load(this, t, e), this.initialized ? this.initFlares() : console.error("Couldn't initialize FlareJS");
        }
        var t = e.prototype;
        return (
            (t.toggle = function () {
...
//# sourceMappingURL=flarejs.umd.js.map
